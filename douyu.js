function sign(xx0, xx1, xx2) {
	var cb = xx0 + xx1 + xx2 + "250120210128";
	var rb = "a4a04d0a2a7dfd77487253510a8215b4";
	var re = [];
	...
	var k2 = [0x2f3c6e98, 0x25f12d6e, 0x2fd220, 0x2804c504];
	for (var I = 0; I < 2; I++) {
		var v0 = re[I * 2],
		v1 = re[I * 2 + 1],
		sum = 0,
	...
	var rt = "v=250120210128" + "&did=" + xx1 + "&tt=" + xx2 + "&sign=" + re;
	return rt;
}
